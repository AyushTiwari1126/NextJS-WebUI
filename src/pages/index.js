    ...
    <>
      ...
      <div className={styles.center}>
         ...
         <div className={styles.grid}>
          ...
          >
            <h2>Onboarding</h2>
            <p>Customer & Merchant Onboarding</p>
          </a>
          ...
          >
            <h2>Issuing</h2>
            <p>Card & Customer Creation, Card Issuing and Digital Wallets</p>
          </a>
          ...
          >
            <h2>Acquiring</h2>
            <p>Mercant acquiring, Connectivity Switch and Payment Gateway</p>
          </a>
        </div>
